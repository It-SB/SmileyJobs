...
namespace Smile.Controllers
{
    public class ApplicationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,UserName,NormalizedUserName,Email,NormalizedEmail,EmailConfirmed,PasswordHash,SecurityStamp,ConcurrencyStamp,PhoneNumber,PhoneNumberConfirmed,TwoFactorEnabled,LockoutEnd,LockoutEnabled,AccessFailedCount,JobId,ApplicantId,ResumeCv,CoverLetter,ApplicationDate,Status,CommentsNotes")] Application application)
        {
